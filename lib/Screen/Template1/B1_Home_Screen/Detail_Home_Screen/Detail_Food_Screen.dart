...
class DetailFoodScreenT1 extends StatefulWidget {
  String? id, image, title;
  DetailFoodScreenT1({this.id, this.image, this.title});

  @override
  _DetailFoodScreenT1State createState() => _DetailFoodScreenT1State();
}

class _DetailFoodScreenT1State extends State<DetailFoodScreenT1> {
  @override
  double rating = 3.5;
          ...
          Row(
            ...
            children: <Widget>[
              Padding(
                  ...
                  child: _infoCircleIcon("assets/icon/wifi.png", "Free Wifi")),
              Padding(
                  padding: const EdgeInsets.only(right: 0.0),
                  child:
                      _infoCircleIcon("assets/icon/rattingPlus.png", "Photo")),
              Padding(
                  padding: const EdgeInsets.only(right: 0.0),
              ...
              Padding(
                  padding: const EdgeInsets.only(right: 0.0),
                  child:
                      _infoCircleIcon("assets/icon/bookmark.png", "Bookmark")),
              Padding(
