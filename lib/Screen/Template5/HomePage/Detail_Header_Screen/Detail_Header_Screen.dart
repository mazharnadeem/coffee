...
class DetailHeaderScreen extends StatefulWidget {
  @override
  _DetailHeaderScreenState createState() => _DetailHeaderScreenState();
}

class _DetailHeaderScreenState extends State<DetailHeaderScreen> {
          ...
          Stack(
            children: <Widget>[
              ...
              ShaderMask(
                  ...
                  child: Image.asset(
                    'assets/Template2/category/category6.jpg',
                    height: 330.0,
                    fit: BoxFit.cover,
