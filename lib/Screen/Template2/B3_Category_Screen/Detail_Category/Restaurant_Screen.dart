...
import 'package:food_template_null_safety/Data_Model/restaurant.dart';
            ...
            Container(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return cardDinner(restaurantDataArray[index]);
                },
                itemCount: restaurantDataArray.length,
              ),
            ),
          ],
        ),
