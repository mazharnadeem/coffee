...
import 'package:food_template_null_safety/Data_Model/streetFoodData.dart';
...
class streetFood extends StatefulWidget {
  streetFood({Key? key}) : super(key: key);

  @override
  _streetFoodState createState() => _streetFoodState();
}
            ...
            Container(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return cardDinner(streetFoodDataArray[index]);
                },
                itemCount: streetFoodDataArray.length,
              ),
            ),
          ],
        ),
