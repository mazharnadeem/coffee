...
import 'package:food_template_null_safety/Data_Model/cateringService.dart';
import 'package:food_template_null_safety/Screen/Template2/B1_Home_Screen/Component_Detail_Food/Food_Detail_Screen.dart';

class CateringServiceT2 extends StatefulWidget {
  CateringServiceT2({Key? key}) : super(key: key);

  @override
  _CateringServiceT2State createState() => _CateringServiceT2State();
}

class _CateringServiceT2State extends State<CateringServiceT2> {
  @override
            ...
            Container(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return cardDinner(cateringServiceDataArray[index]);
                },
                itemCount: cateringServiceDataArray.length,
              ),
            ),
          ],
        ),
